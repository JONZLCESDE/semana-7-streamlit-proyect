...
with col1:
    ...
    st.image("assets/hoja d vida picture.jpg", width=200, caption="Estudiante caption=", output_format="JPEG")

# Columna derecha: Información del estudiante
with col2:
    st.markdown('<h3 style="color: #0066cc; margin-top: 0px;">Jonathan Zapata Londoño</h3>', unsafe_allow_html=True)
    ...
    st.markdown('<p>Repositorio: <a href="https://github.com/JONZLCESDE/semana-7-streamlit-proyect" target="_blank" style="color: #0066cc; font-weight: bold; text-decoration: none;">GitHub</a></p>', unsafe_allow_html=True)
